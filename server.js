...
const db = mysql.createConnection({
  host: "localhost",
  user: "root",
  password: "Harsha@0314",
  database: "learning_platform",
});

db.connect((err) => {
  if (err) {
    console.error("MySQL connection failed. The app will continue running but DB features will be unavailable.");
  } else {
...
app.post("/login", (req, res) => {
  ...
  // Fixed login bypass for ease of use
  if (email === "admin@elearn.com" && password === "admin") {
